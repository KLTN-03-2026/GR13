...
const Blog: React.FC = () => {
  const articles: Article[] = [
    ...
    { id: 3, category: 'Haircare', title: 'Bí quyết phục hồi tóc hư tổn sau khi tẩy', date: '2026-03-15', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500', summary: 'Đừng để mái tóc xơ rối làm bạn mất tự tin. Hãy thử ngay 5 loại mặt nạ này...' },
    ...
    { id: 11, category: 'Makeup', title: 'Cách kẻ mắt mèo chuẩn xác cho người mới bắt đầu', date: '2026-03-08', image: 'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=500', summary: 'Đừng lo lắng nếu tay bạn còn run, hãy áp dụng mẹo nhỏ sau đây...' },
    { id: 12, category: 'Makeup', title: 'Cách kẻ mắt mèo chuẩn xác cho người mới bắt đầu', date: '2026-03-08', image: 'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=500', summary: 'Đừng lo lắng nếu tay bạn còn run, hãy áp dụng mẹo nhỏ sau đây...' },
  ];
