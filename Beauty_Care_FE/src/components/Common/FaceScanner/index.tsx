...
const FaceScanner = React.forwardRef<any, FaceScannerProps>((props, ref) => {
  ...
  const startCamera = async () => {
    ...
    try {
      ...
      let faceModule: any;
      try { faceModule = await import(/* @vite-ignore */ '@mediapipe/face_mesh'); } catch (e) { 
        // @ts-ignore
        faceModule = await import(/* @vite-ignore */ 'https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh/face_mesh.js'); 
      }
